  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <br /><span style={{ color: '#BDC3C7' }}> 26s: £0.26 | Misses: £0.50 | DOTD: £2.50 | Tens: score in pence</span>
      </div>
        ...
        <table style={{
          ...
          <thead>
            <tr style={{ backgroundColor: '#2c3e50', color: '#BDC3C7', fontSize: '11px' }}>
              <th style={{ padding: '3px', textAlign: 'center', border: '1px solid #7f8c8d' }}>Game</th>
